...
export default class Map extends Component {
  ...
  "499": [{ "x": 51, "y": 67 }, { "e": 456 }]
     ...
     render(){
      return(
        <div id="rooms">
          <div id="room0">Room0</div>
          <div id="room1">Room1</div>
          <div id="room2">Room2</div>
          <div id="room3">Room3</div>
          <div id="room4">Room4</div>
          <div id="room5">Room5</div>
          <div id="room6">Room6</div>
          <div id="room7">Room7</div>
          <div id="room8">Room8</div>
          <div id="room9">Room9</div>
          <div id="room9">Room9</div>
        </div>
